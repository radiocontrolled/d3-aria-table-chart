...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_dispatch__ = __webpack_require__(207);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_d3_array__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_interpolate__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__continuous__ = __webpack_require__(54);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__tickFormat__ = __webpack_require__(477);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__line__ = __webpack_require__(340);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__count__ = __webpack_require__(365);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__each__ = __webpack_require__(366);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__eachBefore__ = __webpack_require__(367);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__eachAfter__ = __webpack_require__(368);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__sum__ = __webpack_require__(369);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__sort__ = __webpack_require__(370);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__path__ = __webpack_require__(371);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ancestors__ = __webpack_require__(372);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__descendants__ = __webpack_require__(373);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__leaves__ = __webpack_require__(374);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__links__ = __webpack_require__(375);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_axis__ = __webpack_require__(202);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__array__ = __webpack_require__(377);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_d3_time_format__ = __webpack_require__(24);
...
/* harmony default export */ __webpack_exports__["b"] = (function() {
  return calendar(__WEBPACK_IMPORTED_MODULE_2_d3_time__["D" /* timeYear */], __WEBPACK_IMPORTED_MODULE_2_d3_time__["n" /* timeMonth */], __WEBPACK_IMPORTED_MODULE_2_d3_time__["B" /* timeWeek */], __WEBPACK_IMPORTED_MODULE_2_d3_time__["a" /* timeDay */], __WEBPACK_IMPORTED_MODULE_2_d3_time__["e" /* timeHour */], __WEBPACK_IMPORTED_MODULE_2_d3_time__["j" /* timeMinute */], __WEBPACK_IMPORTED_MODULE_2_d3_time__["r" /* timeSecond */], __WEBPACK_IMPORTED_MODULE_2_d3_time__["h" /* timeMillisecond */], __WEBPACK_IMPORTED_MODULE_3_d3_time_format__["timeFormat"]).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]);
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__continuous__ = __webpack_require__(54);
...
var _dataUtilities = __webpack_require__(183);

var _dataUtilities2 = _interopRequireDefault(_dataUtilities);

var _d3Scale = __webpack_require__(474);

var _d3Axis = __webpack_require__(106);

var _d3TimeFormat = __webpack_require__(24);
...
var Canvas = function () {
  function Canvas(parentDiv) {
    ...
    // set width of SVG
    this.svg = (0, _d3Selection.select)(this.parentDiv).append('svg').attr('width', this.width).attr('height', this.height);

    this.title = this.svg.append('title').text('Monthly percentage change in UK house prices, 2017');

    this.desc = this.svg.append('desc').text('Line chart demonstrating all property types monthly percentage change');

    // position g inside of SVG
    this.canvas = this.svg.append('g').attr('class', 'canvas').attr('width', this.width - this.margins.right - this.margins.left).attr('height', this.height - this.margins.top - this.margins.bottom).attr('transform', 'translate(0, ' + this.margins.top + ')');

    this.table = this.canvas.append('g').attr('role', 'table');
  }
  ...
  _createClass(Canvas, [{
    ...
    value: function updateCanvasDimensions() {
      ...
      this.canvas.attr('width', this.width - this.margins.right - this.margins.left).attr('height', this.height - this.margins.top - this.margins.bottom).attr('transform', 'translate(' + this.margins.left + ', ' + this.margins.top + ')');
    }
  }]);
...
var Chart = function (_Canvas) {
  _inherits(Chart, _Canvas);

  function Chart(parentDiv, data, max) {
    _classCallCheck(this, Chart);

    var _this = _possibleConstructorReturn(this, (Chart.__proto__ || Object.getPrototypeOf(Chart)).call(this, parentDiv, data));

    _this.data = data;

    var DATA_PADDING = 5;
    _this.max = max + DATA_PADDING;

    // draw x axis -----
    _this.xScale = (0, _d3Scale.scaleTime)().domain([_this.data[0].date, _this.data[_this.data.length - 1].date]).range([_this.margins.left, _this.width - _this.margins.right]);

    _this.xAxis = (0, _d3Axis.axisBottom)(_this.xScale).tickFormat((0, _d3TimeFormat.timeFormat)('%b')).ticks(_this.data.length);

    _this.table.append('g').attr('role', 'row').attr('class', 'x axis').call(_this.xAxis).attr('transform', 'translate(0, ' + (_this.height - _this.margins.bottom - _this.margins.top) + ')');

    // add extra a11y attributes to row
    _this.xAxisA11yAttribs = (0, _d3Selection.selectAll)('.x.axis .tick text').attr('role', 'columnheader');

    // draw y axis -----
    _this.yScale = (0, _d3Scale.scaleLinear)().domain([2, -2]).range([_this.margins.bottom, _this.height - _this.margins.top]);

    _this.yAxis = (0, _d3Axis.axisLeft)(_this.yScale);

    _this.canvas.append('g').attr('class', 'y axis').call(_this.yAxis).attr('aria-hidden', true).attr('transform', 'translate(' + _this.margins.left + ', ' + -_this.margins.bottom + ')').append('text').attr('fill', '#2c3e50').attr('transform', 'rotate(-90)').attr('y', 6).attr('dy', '0.5em').attr('dx', '-3em').attr('text-anchor', 'end').attr('aria-hidden', true).text('Per cent change');

    // for each category, draw a line -----
    _dataUtilities2.default.getCategoriesToVisualise(_this.data, 'date').forEach(function (el) {
      var lineGenerator = (0, _d3Shape.line)().x(function (d) {
        return _this.xScale(d.date);
      }).y(function (d) {
        return _this.yScale(d[el]);
      });

      _this.drawLine(_this.data, lineGenerator, el);
      _this.drawLineData(_this.data, el);
    });
    return _this;
  }
  ...
  _createClass(Chart, [{
    ...
    value: function resizeLine(el) {
      ...
      (0, _d3Selection.select)(path).attr('transform', 'translate(0, ' + -this.margins.bottom + ')').attr("d", lineGenerator);
    }
  }, {
    ...
    value: function resizeChartComponents() {
      ...
      (0, _d3Selection.select)('.x.axis').call(this.xAxis).attr('transform', 'translate(0, ' + (this.height - this.margins.bottom - this.margins.top) + ')');
...
_dataUtilities2.default.getData('./data/housePrices.json').then(function (data) {
  var processedData = _dataUtilities2.default.processRawData(data);
  var max = _dataUtilities2.default.getMaxOfData(processedData); // refactor
  var canvas = new Chart('.chart', processedData, max);
...
var getMaxOfData = function getMaxOfData(data) {
  ...
  var flattenedArr = arr.reduce(function (a, b) {
    return a.concat(b);
  }, []);
  return Math.max.apply(Math, _toConsumableArray(flattenedArr));
};

var getData = function getData(path) {
  var d3 = __webpack_require__(184);
...
var processRawData = function processRawData(data) {
  var arr = [];
  for (var i in data) {
    var year = parseInt(i.match(/[0-9]{4}/), 10);
    var month = parseInt('' + i.charAt(5) + i.charAt(6), 10) - 1;
    var day = parseInt('' + i.charAt(8) + i.charAt(9), 10);
...
var getCategoriesToVisualise = function getCategoriesToVisualise(arrayOfObjects, objectPropertyToFilter) {
  return Object.keys(arrayOfObjects[0]).filter(function (category) {
    return category !== objectPropertyToFilter;
  });
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_axis__ = __webpack_require__(106);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_d3_brush__ = __webpack_require__(205);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_d3_format__ = __webpack_require__(27);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_d3_hierarchy__ = __webpack_require__(363);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_d3_polygon__ = __webpack_require__(385);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19_d3_queue__ = __webpack_require__(392);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20_d3_random__ = __webpack_require__(395);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_d3_request__ = __webpack_require__(400);
...
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "create", function() { return __WEBPACK_IMPORTED_MODULE_23_d3_selection__["create"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24_d3_shape__ = __webpack_require__(160);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25_d3_time__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26_d3_time_format__ = __webpack_require__(24);
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "timeFormatDefaultLocale", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["timeFormatDefaultLocale"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "timeFormat", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["timeFormat"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "timeParse", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["timeParse"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "utcFormat", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["utcFormat"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "utcParse", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["utcParse"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "timeFormatLocale", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["timeFormatLocale"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "isoFormat", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["isoFormat"]; });
/* harmony namespace reexport (by provided) */ __webpack_require__.d(__webpack_exports__, "isoParse", function() { return __WEBPACK_IMPORTED_MODULE_26_d3_time_format__["isoParse"]; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__identity__ = __webpack_require__(204);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_brush__ = __webpack_require__(206);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_radial__ = __webpack_require__(323);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_x__ = __webpack_require__(324);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_y__ = __webpack_require__(325);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_bounds__ = __webpack_require__(336);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_centroid__ = __webpack_require__(337);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_clip_extent__ = __webpack_require__(339);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_contains__ = __webpack_require__(341);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_graticule__ = __webpack_require__(342);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_interpolate__ = __webpack_require__(343);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_path_index__ = __webpack_require__(344);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__src_projection_albersUsa__ = __webpack_require__(352);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__src_projection_azimuthalEqualArea__ = __webpack_require__(353);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__src_projection_azimuthalEquidistant__ = __webpack_require__(354);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__src_projection_conicConformal__ = __webpack_require__(355);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__src_projection_conicEquidistant__ = __webpack_require__(356);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__src_projection_gnomonic__ = __webpack_require__(357);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__src_projection_identity__ = __webpack_require__(358);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__src_projection_naturalEarth1__ = __webpack_require__(359);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__src_projection_orthographic__ = __webpack_require__(360);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__src_projection_stereographic__ = __webpack_require__(361);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__src_projection_transverseMercator__ = __webpack_require__(362);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__area__ = __webpack_require__(345);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__bounds__ = __webpack_require__(144);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__centroid__ = __webpack_require__(346);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__context__ = __webpack_require__(347);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__measure__ = __webpack_require__(348);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__string__ = __webpack_require__(349);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_cluster__ = __webpack_require__(364);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_pack_index__ = __webpack_require__(376);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_partition__ = __webpack_require__(378);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_stratify__ = __webpack_require__(379);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_tree__ = __webpack_require__(380);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_treemap_index__ = __webpack_require__(381);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__src_treemap_binary__ = __webpack_require__(382);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_treemap_sliceDice__ = __webpack_require__(383);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__src_treemap_resquarify__ = __webpack_require__(384);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_area__ = __webpack_require__(386);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_centroid__ = __webpack_require__(387);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_hull__ = __webpack_require__(388);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_contains__ = __webpack_require__(390);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_length__ = __webpack_require__(391);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__cross__ = __webpack_require__(389);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_queue__ = __webpack_require__(393);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__array__ = __webpack_require__(394);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_uniform__ = __webpack_require__(396);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_logNormal__ = __webpack_require__(397);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_bates__ = __webpack_require__(398);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_exponential__ = __webpack_require__(399);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_html__ = __webpack_require__(401);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_json__ = __webpack_require__(402);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_text__ = __webpack_require__(403);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_xml__ = __webpack_require__(404);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_csv__ = __webpack_require__(405);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_tsv__ = __webpack_require__(406);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_time_format__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_time__ = __webpack_require__(23);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_band__ = __webpack_require__(475);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_identity__ = __webpack_require__(476);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_log__ = __webpack_require__(478);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_pow__ = __webpack_require__(479);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_quantile__ = __webpack_require__(480);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_quantize__ = __webpack_require__(481);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__src_threshold__ = __webpack_require__(482);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__src_utcTime__ = __webpack_require__(483);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__src_sequential__ = __webpack_require__(484);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__continuous__ = __webpack_require__(54);
